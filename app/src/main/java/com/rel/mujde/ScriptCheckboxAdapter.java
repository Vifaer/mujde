...
public class ScriptCheckboxAdapter extends RecyclerView.Adapter<ScriptCheckboxAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final String scriptName = availableScripts.get(position);
        // 复用 ViewHolder 时先清监听，避免错乱
        holder.scriptCheckbox.setOnCheckedChangeListener(null);
        holder.scriptCheckbox.setText(scriptName);
        holder.scriptCheckbox.setTextColor(
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        MaterialCheckBox scriptCheckbox;
